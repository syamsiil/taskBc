const promise = new Promise((resolve, reject) => {
  ...
  xhr.open("GET", "https://api.npoint.io/cc45dcfdfee68e89b313", true);
  //   console.log(xhr);

  xhr.onload = () => {
    if (xhr.status === 200) {
      // We parsing it so it is easier to read in console
      // response vs responseText, the difference are, responseText is an older version and output is still the similiar
